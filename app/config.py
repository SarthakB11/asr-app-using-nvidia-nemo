...
# Model Configuration
ONNX_MODEL_NAME = os.getenv("ONNX_MODEL_NAME", "stt_hi_conformer_ctc_medium.onnx")
MODELS_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "models") # Points to project_root/models
